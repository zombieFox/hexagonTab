...
const ControlModule_color = function({ object = {}, path = false, id = 'name', labelText = 'Name', srOnly = false, value = 0, defaultValue = false, action = false, extraButtons = [] } = {}) {
  ...
  this.wrap = () => {
    const formGroup = form_form.render.groupBlock([
      this.color,
      this.text
    ]);
...
const ControlModule_radio = function({ radioGroup = [], object = {}, groupName = 'group', path = false, action = false } = {}) {
  ...
  this.inline = () => {
    ...
    const formInline = form_form.render.inlineWide();
...
theme_theme.mod.color = {
  ...
  generated: function() {
    const shades = theme_theme.mod.color.shades({
      rgb: state_state.get.current().theme.color.rgb,
      contrastNegative: state_state.get.current().theme.color.contrast.dark,
      contrastPositive: state_state.get.current().theme.color.contrast.light
    });
    state_state.get.current().theme.color.generated.negative = shades.negative;
    state_state.get.current().theme.color.generated.positive = shades.positive;
  }
};
...
theme_theme.render.color.shade = function() {
  const html = document.querySelector('html');
  // negative
  for (var i = 10; i >= 1; i--) {
    var rgb = state_state.get.current().theme.color.generated.negative[i];
    var number = i;
    if (i < 10) {
      number = '0' + number;
    };
  ...
  // neutral
  var rgb = state_state.get.current().theme.color.rgb;
  html.style.setProperty('--theme-shade', rgb.r + ', ' + rgb.g + ', ' + rgb.b);
  // positive
  for (var i = 1; i <= 10; i++) {
    var rgb = state_state.get.current().theme.color.generated.positive[i];
    var number = i;
    if (i < 10) {
      number = '0' + number;
    };
...
theme_theme.render.accent.color = function() {
  const html = document.querySelector('html');
...
theme_theme.init = function() {
  ...
  theme_theme.mod.color.generated();
  theme_theme.render.color.shade();
...
menuContentTheme.color = function() {
  ...
  const themeColorMixer = new ControlModule_colorMixer({
    ...
    defaultValue: state_state.get.default().theme.color.rgb,
  ...
  const themeColorContrastLight = new ControlModule_slider({
    ...
    value: state_state.get.current().theme.color.contrast.light,
    defaultValue: state_state.get.default().theme.color.contrast.light,
    min: state_state.get.minMax().theme.color.contrast.light.min,
    max: state_state.get.minMax().theme.color.contrast.light.max,
    action: () => {
      theme_theme.mod.color.generated();
      theme_theme.render.color.shade();
      data.save();
  ...
  const themeColorContrastDark = new ControlModule_slider({
    ...
    value: state_state.get.current().theme.color.contrast.dark,
    defaultValue: state_state.get.default().theme.color.contrast.dark,
    min: state_state.get.minMax().theme.color.contrast.dark.min,
    max: state_state.get.minMax().theme.color.contrast.dark.max,
    action: () => {
      theme_theme.mod.color.generated();
      theme_theme.render.color.shade();
      data.save();
